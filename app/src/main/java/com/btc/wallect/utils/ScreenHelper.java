...
public class ScreenHelper {
    ...
    private static float convertDP(int unit, float in) {
        return TypedValue.applyDimension(unit, in, WallectApp.getContext().getResources().getDisplayMetrics());
    }

    public static int getScreenWidth() {
        DisplayMetrics dm = WallectApp.getContext().getResources().getDisplayMetrics();
